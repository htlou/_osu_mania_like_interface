...
//    addItem(quitButton);
    ...
    addItem(setting);
    connect(setting, &MenuButton::clicked, this, &MainMenu::GenAnimation2);
...
void MainMenu::GenAnimation2(){
    ...
    opacityAnimation_->setKeyValueAt(1.0,0.0);
    opacityAnimation_->start();
    connect(opacityAnimation,&QPropertyAnimation::finished,this,&MainMenu::enter_settings_slot);
}
